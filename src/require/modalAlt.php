...
if (isset($_POST['duplicar'])){
    $material = new Material(null, $_POST['matNome'], $_POST['matDescricao'], $_POST['matFabricante'], $_POST['matModelo'], $_POST['matTipo'], $_POST['matQuant'], $_POST['matDataInclusao'], $_POST['matDataBaixa'], $_POST['matValorCarga'], $_POST['matDataValorCotacao'], $_POST['matValorCotacao'], $_POST['matPrevAlocDep'], $_POST['matCatMat'], $_POST['matNumSerie']);

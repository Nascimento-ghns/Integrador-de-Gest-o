<div class="row" id="navbar">
    ...
    <div class="col-md-8 text-center">
        ...
        <div class="row menus2">
            ...
            <div class="col-md-3 menu d-flex flex-column justify-content-center align-items-center fundoCinza"><a href="materialDependencia.php">Material por Dependencia</a></div>
